...
clear >/dev/null 2>&1
str="/data/media/0"
root="/data/data/com.tencent.ig"
files="/Android/data/com.tencent.ig/files"
data="/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved"
...
rm -rf /data/app/com.tencent.ig-*/lib/arm*/libBugly.so >/dev/null 2>&1
rm -rf /data/app/com.tencent.ig-*/lib/arm*/libhelpshiftlistener.so >/dev/null 2>&1
rm -rf /data/app/com.tencent.ig-*/lib/arm*/libigshare.so >/dev/null 2>&1
rm -rf /data/app/com.tencent.ig-*/lib/arm*/libzip.so >/dev/null 2>&1
su -c iptables --flush
su -c am start -n com.tencent.ig/com.epicgames.ue4.SplashActivity >/dev/null 2>&1
...
Adarsh ()
{
am force-stop com.tencent.ig:imsdk_inner_webview >/dev/null 2>&1
am force-stop com.tencent.ig:vlink >/dev/null 2>&1
am force-stop com.tencent.ig:networkDetector >/dev/null 2>&1

killall -q com.tencent.ig:imsdk_inner_webview >/dev/null 2>&1
killall -q com.tencent.ig:vlink >/dev/null 2>&1
killall -q com.tencent.ig:networkDetector >/dev/null 2>&1
...
rm -rf $str/Tencent
rm -rf $str/tencent
rm -rf $str/Android/data/com.tencent.ig/cache
