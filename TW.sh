...
clear >/dev/null 2>&1
str="/data/media/0"
root="/data/data/com.rekoo.pubgm"
files="/Android/data/com.rekoo.pubgm/files"
data="/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved"
...
rm -rf /data/app/com.rekoo.pubgm-*/lib/arm*/libBugly.so >/dev/null 2>&1
rm -rf /data/app/com.rekoo.pubgm-*/lib/arm*/libhelpshiftlistener.so >/dev/null 2>&1
rm -rf /data/app/com.rekoo.pubgm-*/lib/arm*/libigshare.so >/dev/null 2>&1
rm -rf /data/app/com.rekoo.pubgm-*/lib/arm*/libzip.so >/dev/null 2>&1
su -c iptables --flush
su -c am start -n com.rekoo.pubgm/com.epicgames.ue4.SplashActivity >/dev/null 2>&1
...
Adarsh ()
{
am force-stop com.rekoo.pubgm:imsdk_inner_webview >/dev/null 2>&1
am force-stop com.rekoo.pubgm:vlink >/dev/null 2>&1
am force-stop com.rekoo.pubgm:networkDetector >/dev/null 2>&1

killall -q com.rekoo.pubgm:imsdk_inner_webview >/dev/null 2>&1
killall -q com.rekoo.pubgm:vlink >/dev/null 2>&1
killall -q com.rekoo.pubgm:networkDetector >/dev/null 2>&1
...
rm -rf $str/Tencent
rm -rf $str/tencent
rm -rf $str/Android/data/com.rekoo.pubgm/cache
...
pm install -r /data/app/com.rekoo.pubgm-*/base.apk >/dev/null 2>&1
unport
unport
echo ""
