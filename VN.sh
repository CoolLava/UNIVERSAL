...
clear >/dev/null 2>&1
str="/data/media/0"
root="/data/data/com.vng.pubgmobile"
files="/Android/data/com.vng.pubgmobile/files"
data="/Android/data/com.vng.pubgmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved"
...
rm -rf /data/app/com.vng.pubgmobile-*/lib/arm*/libBugly.so >/dev/null 2>&1
rm -rf /data/app/com.vng.pubgmobile-*/lib/arm*/libhelpshiftlistener.so >/dev/null 2>&1
rm -rf /data/app/com.vng.pubgmobile-*/lib/arm*/libigshare.so >/dev/null 2>&1
rm -rf /data/app/com.vng.pubgmobile-*/lib/arm*/libzip.so >/dev/null 2>&1
su -c iptables --flush
su -c am start -n com.vng.pubgmobile/com.epicgames.ue4.SplashActivity >/dev/null 2>&1
...
Adarsh ()
{
am force-stop com.vng.pubgmobile:imsdk_inner_webview >/dev/null 2>&1
am force-stop com.vng.pubgmobile:vlink >/dev/null 2>&1
am force-stop com.vng.pubgmobile:networkDetector >/dev/null 2>&1

killall -q com.vng.pubgmobile:imsdk_inner_webview >/dev/null 2>&1
killall -q com.vng.pubgmobile:vlink >/dev/null 2>&1
killall -q com.vng.pubgmobile:networkDetector >/dev/null 2>&1
...
rm -rf $str/Tencent
rm -rf $str/tencent
rm -rf $str/Android/data/com.vng.pubgmobile/cache
